...
export class SidebarComponent {
  ...
  navItems = [
    { label: 'Dashboard', route: '/dashboard', badge: 0,
    ...
    { label: 'Órdenes',   route: '/ordenes',   badge: 7,
    ...
    { label: 'Clientes',  route: '/clientes',  badge: 0,
    ...
    { label: 'Vehículos', route: '/vehiculos', badge: 0,
    ...
    { label: 'Servicios', route: '/servicios', badge: 0,
      icon: `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14.7 6.3a1 1 0 000 1.4l1.6 1.6a1 1 0 001.4 0l3.77-3.77a6 6 0 01-7.94 7.94l-6.91 6.91a2.12 2.12 0 01-3-3l6.91-6.91a6 6 0 017.94-7.94z"/></svg>` },
    { label: 'Reportes',  route: '/reportes',  badge: 0,
